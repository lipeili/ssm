...
<body>
    ...
    <table >
        ...
        <c:forEach items="${accounts}" var="item" varStatus="status">
            <form action="/ssm/account/delete" id="${item.id}">
                <tr>
                    ...
                    <td><input  type="submit" class="update" value="修改" id="${item.id}" ></td>
                </tr>
            </form>
        </c:forEach>
    </table>
    ...
    <div id = "updatePan" style="display: none;">
        <form action="/ssm/account/update">
...
<script>
    $(function () {
        ...
        $(".update").bind("click",function () {
            ...
            // 发送ajax请求
            $.ajax({
                url: '/ssm/account/queryDetail?' + "id=" + val,
                type: 'GET',
                // data: '{"id":"1","name":"李四"}',
